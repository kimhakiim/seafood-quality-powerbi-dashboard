...
**Power BI Portfolio Project** | Data Analytics Career Pivot

![Dashboard Preview](assets/preview.png)
> *Screenshot placeholder — replace with actual dashboard screenshots*
...
| `Dim_Date` | Dimension | — | Date table for time intelligence |
| `Dim_Shift` | Dimension | — | Shift master data |
...
> Full insight log with recommended actions and target departments available in [`Insight_Log.xlsx`](Insight_Log.xlsx)

> Screenshot placeholder — replace with actual Insight_Log screenshot
![Insight Log](assets/insight_log.png)
...
> Data quality issues identified during ETL process in Power Query. Full log available in [`Issue_Log.xlsx`](Issue_Log.xlsx)
...
- Power Query / Excel (data preparation & ETL)
- Figma (custom dashboard background design — 1280x720px)
...
Built by **[Your Name]** as part of a career pivot into data analytics, leveraging domain expertise in seafood/fisheries and a background in data annotation.
...
*This is a portfolio project using simulated data. All company names, supplier names, and inspector names are fictional.*
